BEGIN;
-- db/migrations/2026-08-03-ops4-function-privileges.sql
-- 镜像里对应的是 db/views/zzz_function_grants.sql(必须在 tables 之后跑,见该文件)
...
--
-- 【文件名以 zz_ 开头是有意的】db/functions 按文件名顺序重放,本文件必须排在
-- 所有 CREATE FUNCTION 之后。它不定义任何函数,只声明权限。
--
