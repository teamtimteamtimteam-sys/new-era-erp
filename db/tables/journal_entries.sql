...
CREATE TABLE public.journal_entries (
    ...
    memo        text,
    source_type text CHECK (source_type IN ('manual','purchase','sale','processing_cost','allocation','stocktake','writeoff','payment','fx','expense','prepayment','payroll','transfer')),
    source_id   uuid,
