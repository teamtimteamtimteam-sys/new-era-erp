CREATE OR REPLACE FUNCTION public.record_fx_rate(p_currency text, p_rate_date date, p_rate_type text, p_rate numeric, p_source text DEFAULT 'DBS'::text, p_notes text DEFAULT NULL::text, p_reason text DEFAULT NULL::text)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
