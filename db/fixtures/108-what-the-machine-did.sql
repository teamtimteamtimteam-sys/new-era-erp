...
BEGIN
    ...
    INSERT INTO materials (code, name, category) VALUES ('ZZFIX108-M', 'fixture 108 raw', 'black_mass') RETURNING id INTO v_mat;
    INSERT INTO materials (code, name, category) VALUES ('ZZFIX108-MB', 'fixture 108 out', 'black_mass') RETURNING id INTO v_matB;
