...
BEGIN
    ...
    INSERT INTO materials (code, name, kind_code, may_be_processed, form_code, source_code) VALUES ('FX98-MAT','fixture 98', 'battery_material', true, 'black_mass', 'end_of_life') RETURNING id INTO mat;
