...
BEGIN
    ...
    INSERT INTO materials (code, name, category) VALUES ('ZZFIX109-M', 'fixture 109 raw', 'black_mass') RETURNING id INTO v_mat;
    INSERT INTO materials (code, name, category) VALUES ('ZZFIX109-MB', 'fixture 109 out', 'black_mass') RETURNING id INTO v_matB;
