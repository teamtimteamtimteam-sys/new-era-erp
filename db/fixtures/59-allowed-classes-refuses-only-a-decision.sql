...
BEGIN
    ...
    INSERT INTO materials (code, name, category, unit, waste_classification_code)
    VALUES ('ZZFIX59-N', 'fixture 59 non-focused', '进料-电池', 'kg', 'non_focused') RETURNING id INTO m_non;
    -- 【不写 waste_classification_code】—— 未分类是"没有人分过类",不是某个值
    INSERT INTO materials (code, name, category, unit)
    VALUES ('ZZFIX59-U', 'fixture 59 unclassified', '进料-电池', 'kg') RETURNING id INTO m_null;
