...
-- ★ AP-RECON-1 Batch B(2026-09-24):本 fixture 的日期从 2029 挪到 2025(真实的过去)。三条日期规矩落地之后,晚于今天的单据与晚于本月末的分录都按名拒,而且【没有测试开关】(Tim AP-RECON-1 Q7 / Batch B Q8)—— 所以挪的是 fixture,不是闸。
--
...
DECLARE
    ...
    d_quote date := '2025-03-05';   -- 只有报价
    d_post  date := '2025-03-20';   -- 只有过账
    d_mixed date := '2025-04-10';   -- 两者都有
