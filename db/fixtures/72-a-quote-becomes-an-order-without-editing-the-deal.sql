...
BEGIN
    ...
    VALUES ('ZZFIX72-M', 'f72 material', 'battery_material', true, 'black_mass', 'end_of_life', 'kg') RETURNING id INTO v_mat;
    INSERT INTO materials (code, name, kind_code, may_be_processed, form_code, source_code, unit)
    VALUES ('ZZFIX72-M2', 'f72 material 2', 'battery_material', true, 'black_mass', 'end_of_life', 'kg') RETURNING id INTO v_mat2;
