...
BEGIN
    ...
    VALUES ('ZZFIX60-W', 'fixture 60 watched', 'battery_material', true, 'black_mass', 'end_of_life', 'kg', 50) RETURNING id INTO m_watch;
    ...
    VALUES ('ZZFIX60-U', 'fixture 60 unmonitored', 'battery_material', true, 'black_mass', 'end_of_life', 'kg') RETURNING id INTO m_null;
