...
BEGIN
    ...
    VALUES ('ZZFIX64-M', 'f64 material', '产出-金属', 'kg') RETURNING id INTO v_mat;
    INSERT INTO materials (code, name, category, unit, waste_classification_code)
    VALUES ('ZZFIX64-N', 'f64 classified', '产出-金属', 'kg', 'non_focused') RETURNING id INTO m_cls;
    INSERT INTO materials (code, name, category, unit, safety_stock_qty)
    VALUES ('ZZFIX64-S', 'f64 safety-watched', '产出-金属', 'kg', 50) RETURNING id INTO m_saf;
