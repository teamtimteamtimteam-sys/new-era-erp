...
const PURCHASING_ERROR_CODES = new Set([
    ...
    'SUPPLIER_NOT_FOUND', 'NO_LINES',
    // ROLE-1 Batch 2a:新采购单的供应商必须已批准(trg_purchase_orders_supplier_approved)
    'PO_SUPPLIER_NOT_APPROVED', 'MATERIAL_NOT_FOUND', 'LINE_QTY_INVALID',
