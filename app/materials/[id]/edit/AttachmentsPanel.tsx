...
export default function AttachmentsPanel({
    ...
    function handleDelete(id: string) {
        if (!window.confirm(t('materials.attachments.deleteConfirm'))) return
        startTransition(async () => {
            ...
            {rows.length === 0 ? (
                ...
                <table className="w-full border-collapse border border-gray-300 mb-6">
                    <thead className="bg-gray-100">
                        <tr>
                            <th className="border border-gray-300 px-4 py-2 text-left">{t('materials.attachments.colName')}</th>
                            <th className="border border-gray-300 px-4 py-2 text-left">{t('materials.attachments.colCategory')}</th>
                            <th className="border border-gray-300 px-4 py-2 text-left">{t('materials.attachments.colType')}</th>
                            <th className="border border-gray-300 px-4 py-2 text-left">{t('materials.attachments.colSize')}</th>
                            <th className="border border-gray-300 px-4 py-2 text-left">{t('materials.attachments.colCreated')}</th>
                            <th className="border border-gray-300 px-4 py-2 text-left">{t('materials.attachments.colActions')}</th>
                        </tr>
                    </thead>
                    <tbody>
                        {rows.map((row) => (
