...
export default function FinanceAttachmentsPanel({
    ...
    return (
        <section className="mt-8 pt-8 border-t">
            ...
            {rows.length === 0 ? (
                <p className="text-sm text-gray-500 mb-6">{t('finAttach.empty')}</p>
            ) : (
                <table className="w-full border-collapse border border-gray-300 mb-6">
                    <thead className="bg-gray-100">
                        <tr>
                            <th className="border border-gray-300 px-4 py-2 text-left">{t('finAttach.file')}</th>
                            <th className="border border-gray-300 px-4 py-2 text-left">{t('finAttach.docType')}</th>
                            <th className="border border-gray-300 px-4 py-2 text-left">{t('finAttach.size')}</th>
                            <th className="border border-gray-300 px-4 py-2 text-left">{t('finAttach.uploadedAt')}</th>
                            <th className="border border-gray-300 px-4 py-2 text-left">{t('finAttach.notes')}</th>
                    ...
                    <tbody>
                        {rows.map((row) => (
                            <tr key={row.id}>
                                ...
                                <td className="border border-gray-300 px-4 py-2 text-sm">{docTypeLabel(row.doc_type)}</td>
                                ...
                                <td className="border border-gray-300 px-4 py-2 text-sm text-gray-600">{row.notes ?? '—'}</td>
