// app/tools/pricing/metal-prices/bulk/page.tsx
...
export default async function BulkPricesPage({
    ...
    return (
        <div className="p-8">
            <div className="mb-6">
                <Link href="/tools/pricing/metal-prices" className="hover:underline text-sm app-link">
                    {t('common.back')}
                </Link>
            </div>

            <h1 className="mb-4">{t('metalPrices.bulk.title')}</h1>
