...
export default function AttachmentsPanel({
    ...
    return (
        <section className="mt-8 pt-8 border-t">
            <h2 className="mb-4">{t('customers.attachments.sectionTitle')}</h2>
            ...
            <h3 className="mb-3">{t('customers.attachments.addTitle')}</h3>
            ...
            <form key={formKey} action={handleUpload} className="space-y-3">
                ...
                <div>
                    <label className="block mb-1">{t('customers.attachments.category')}</label>
                    <select
                        name="doc_category"
                        defaultValue=""
                ...
                <div>
                    <label className="block mb-1">{t('customers.attachments.notes')}</label>
                    <input
                        type="text"
                        name="notes"
