...
export const PRICING_ERROR_CODES = new Set([
    ...
    // ROLE-1 Batch 4b:收货定价申请 —— 提、批、驳、撤回都落进这一个翻译器
    'RECEIPT_PRICE_REQUEST_OPEN', 'RECEIPT_PRICE_BELOW_SETTLED', 'RECEIPT_PRICE_NO_OTHER_DECIDER',
    'RECEIPT_PRICE_CHANGED_SINCE_REQUEST', 'RECEIPT_PRICE_REQUEST_NOT_FOUND',
    'RECEIPT_PRICE_REQUEST_NOT_SUBMITTED', 'RECEIPT_PRICE_REQUEST_NOT_OPEN',
    'RECEIPT_PRICE_REQUEST_REJECT_REASON_REQUIRED', 'APPROVALS_NOT_ENABLED',
    'SELF_APPROVAL_FORBIDDEN', 'APPROVAL_NOT_AUTHORISED', 'PERIOD_LOCKED',
    // ROLE-1 Batch 3a:已定价的收货不再换供应商 / 采购单 / 采购行(收货编辑那条路也落进这个翻译器)
    'RECEIPT_PRICED_SOURCE_FROZEN',
])
