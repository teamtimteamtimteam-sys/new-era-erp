...
export async function updateInbound(
    ...
    // unit_price is likewise immutable here since cut 1 (DB trigger PRICE_VIA_FUNCTION):
    // changes go through set_inbound_unit_price via the pricing panel, with audit trail.
