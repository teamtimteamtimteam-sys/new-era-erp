...
// ==========================================================================
// 【瞄准 · AIM】
//   我读的是      :app/ 下的 AST,数「长得像按钮」的 <Link>/<a>。
//   我声称管的是   :给 BTN 那一族一个**重新数得出来**的数。
//   两者不同之处   :**「长得像按钮」是一条手写的形状判据,不是外观。**
//                   一个 className 在运行期拼出来的按钮态链接我看不见 ——
//                   check-component-library 的收尾把这条盲区逐字写着。
