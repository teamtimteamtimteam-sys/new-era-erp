...
//
// 本次生成时的实测:路由 199 条,深度分布 {"0":1,"1":31,"2":138,"3":27,"4":2},
// 深(≥3)的 29 条 —— 这就是 Tim 的 D4 说的"23 条深路由"。
//
...
export const DEPTH_HISTOGRAM: Readonly<Record<string, number>> = {"0":1,"1":31,"2":138,"3":27,"4":2}
