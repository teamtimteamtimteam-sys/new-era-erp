const en = {
    ...
    finance: {
        ...
        reverseUseSourcePathTransfer: 'This entry was posted by a bank transfer. A transfer is reversed as a transfer, never by reversing its journal entry.',
        paymentRequests: {
        ...
        errors: {
            ...
            PAYMENT_REQUEST_REQUIRED: 'Money leaves only after approval, so this needs a payment request approved by the CFO. For a payment, raise it under Finance → Payments → Record payment; for a reversal, use "Request reversal" on the payment.',
            ...
            JE_REVERSE_USE_SOURCE_PATH: 'Entry {0} was posted by a payment or a bank transfer, so it cannot be reversed here. Reverse a payment with "Request reversal" on the payment itself (the CFO approves it first); a transfer is reversed as a transfer.',
