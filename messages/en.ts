const en = {
    ...
    reminders: {
        ...
        basis: 'Days waited are counted by the database against its own current date (from item_date), not your device timezone.',
    ...
    financeOverview: {
        ...
        periodSpans: 'Locking happens on /finance/close and this month\'s remaining steps are on /finance/month-end; neither answers, as its headline, which day the books are currently locked to.',
        ...
        reconSpans: 'The ledger side is on /finance/trial-balance; the document side is spread across /finance/receivables, /finance/payables and the inventory pages — whether the two agree is answered by no page at all.',
        ...
        netSpans: 'Receivables are on /finance/receivables and payables on /finance/payables — each page states half; no page states the two together.',
    ...
    hrOverview: {
        ...
        headcountSpans: '/hr/employees is a register — it lists people, it does not state a composition; /hr/departments covers departments only.',
        ...
        cycleSpans: '/hr/attendance covers attendance and /hr/payroll covers pay — but whether this month can be paid at all depends on how the two meet, and neither page says so.',
        ...
        salarySpans: 'On /hr/employees this exists one person at a time; its total is stated nowhere, and /hr/payroll states a different measure.',
    ...
    auditTrail: {
        ...
        seam: {
            ...
            polymorphic_source: 'Reached from the journal by resolving source_type, which names a concept rather than a table.',
