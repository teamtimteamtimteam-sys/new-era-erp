const en = {
    ...
    finance: {
        ...
        errors: {
            ...
            JE_REVERSE_USE_SOURCE_PATH: 'Entry {0} was posted by a payment, a bank transfer or a withholding tax remittance, so it cannot be reversed here. Use "Request reversal" on the payment, the transfer (Finance → Bank) or the remittance (Finance → Withholding tax); the CFO approves it first.',
