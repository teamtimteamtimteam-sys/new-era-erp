...
const zh = {
    logistics: {
        ...
        createBlocked: '暂时还不能在这里新建集装箱。无缝的 CTR- 取号器【有意】不对应用会话开放执行权(只有 SECURITY DEFINER 函数调得动它,正如 ship_order 调发货单取号器那样),所以要先在库这一侧落一个 create_container 函数。直接在库里建出来的箱子,这一页立刻就能看到。',
        colContainerCode: '箱',
